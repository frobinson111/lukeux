              ...
              >
                ...
                <div className="flex border-t-2 border-slate-300">
                  <button
                    ...
                    className="flex-1 h-[48px] bg-slate-50 px-4 text-sm font-semibold text-slate-700 transition-colors hover:bg-slate-100"
                  >
                    Download
                  </button>
                  ...
                  <button
                    type="button"
                    onClick={() => setFigmaExportSrc(rawWireframes[idx] || src)}
                    className="flex items-center justify-center gap-1.5 h-[48px] bg-slate-50 px-4 text-sm font-semibold text-slate-700 transition-colors hover:bg-slate-100"
                  >
                    <svg className="h-4 w-4" viewBox="0 0 38 57" fill="none" xmlns="http://www.w3.org/2000/svg">
